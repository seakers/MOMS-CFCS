...
function [Z,matchingEdges,matchSizes,matchSizesForFeatMatch,matching]=clusterAnalysisWithXminDist(x,y,distFunc,varargin)
...
matching=compareClustersFirstInXminDist(cutoffCls,y,varargin{1}, x, distFunc, false);
