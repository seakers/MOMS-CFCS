...
function [Z,matchingEdges,matchSizes,matchSizesForFeatMatch,matching]=clusterAnalysisWithX(x,y,distFunc,varargin)
...
matching=compareClustersMatchFirstInX(cutoffCls,y,varargin{1}, x, distFunc, false);
